              ...
              children: [
                ...
                Flexible(
                  child: Padding(
                    ...
                    child: Text(
                      'An nhìn lời mời đáng ngại của Huy. \"Không được,\" An nghĩ thầm, \"Mình không thể tham gia một nhóm chỉ để nói xấu và xa lánh bạn bè. Điều đó thật không đúng chút nào.\"\n\nKhông một chút do dự, An dùng ngón tay nhấn dứt khoát vào nút \'Từ chối\'. Ngay lập tức, màn hình hiển thị thông báo: \"Bạn đã từ chối tham gia nhóm chat này\".\n\nAn cảm thấy nhẹ nhõm trong lòng. Cô bé tự nhủ: \"Mình sẽ không để chuyện này ảnh hưởng đến tình bạn của cả lớp. Mình vẫn sẽ chơi và đối xử tốt với Nam như bình thường thôi.\" Chọn không tham gia vào việc làm xấu là một quyết định đúng đắn.',
